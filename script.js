...
const initialNavItems = [
    ...
    { id: "kyuukyuu-rules", name: "救急隊用ルール", prefix: "KR" },
    { id: "fudousan-rules", name: "不動産用ルール", prefix: "FR" },
    { id: "mechanic-rules", name: "メカニック用ルール", prefix: "MR" },
    { id: "insyokuten-rules", name: "飲食店用ルール", prefix: "IR" },
    { id: "criminal-rules", name: "犯罪者用ルール", prefix: "CR" },
    { id: "gang-rules", name: "ギャングルール", prefix: "GR" },
    { id: "related-rules", name: "闇医者用ルール", prefix: "RR" },
    { id: "tokubetu-rules", name: "特別ルール", prefix: "TR" },
