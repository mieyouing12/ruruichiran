...
const initialRules = {
    ...
    "ban-rules": [
        ...
        { id: "2.10", description: "ほかの街で永久BANされているのにサーバーに参加する行為" },
    ...
    "server-rules": [
        ...
        { id: "3.031", description: "<b>【飛行機の性能カスタムについて】</b>\n\nヘリを含む飛行機の、性能カスタムを禁止" },
        { id: "3.032", description: "<b>【ROBについて】</b>\n\nROB行為は横取り中以外禁止とする\n横取り中にとれるものはミッションで得たもののみに限る" },
        { id: "3.033", description: "<b>【Advanced Lockpick の使用について】</b>\n\n鍵の閉まっている車にAdvanced Lockpick を使用して、鍵を開けて中身をとる行為を禁止\n※ROBに値するため" }
    ],
    "police-rules": [
        { id: "4.1", description: "<b>【警察全般】</b>\n犯罪者や闇医者に対してリスペクトを欠かさないようにすること\n\n<b>全ランクの職員は汚職を行ってはならない。</b>\n\n※汚職とは、警察の情報を過剰に敵対組織に漏らすこと。軽強盗罪以上の犯罪に加担すること。その他、敵対組織に有利に働くことである。\n※交渉の末に金品を一部渡す事等は司法取引になり、汚職ではない。\n\nウェポンロッカーにある銃器やアイテムを持ち出して販売してはいけない。\n\nお互いの犯罪を見逃してはいけません。" },
        ...
        { id: "4.7", description: "<b>【ミッション対応人数について】</b>\n\n確認できる犯罪者数プラス２人までに心掛けるようにすること" },
        { id: "4.8", description: "<b>【走り方について】</b>\n\nflee4 のような戦闘で有利になるエモートを使用して犯罪を行う行為を禁止\n\n例（随時追加よてい）\n・bigfoot" }
    ],
    "kyuukyuu-rules": [
    ...
    "mechanic-rules": [
        { id: "7.1", description: "<b>【メカニック全般】</b>\n\n1. カスタム作業および料金について\n市が定める カスタム最低価格（以下、定価）を下回る価格での販売は禁止します。\n　→ プレイヤーとの関係値による割引であっても定価以下にはできません。\n\nイベントクーポンなど、公式認可された割引は例外として許可します（※事前に市長へ相談すること）。\n\nパーツの取り外し・性能ダウン作業は無料で行っても問題ありません。\n\nパーツのアップグレード作業は、定価の差額のみ請求して良いものとします。\n\n試走目的でのパーツ仮取り付けは可能ですが、以下を遵守してください。\n\n試走時間は最大5分以内\n\n試走後、必ずパーツの取り外しまたは料金請求を行うこと\n\nメカニック専用アイテムの非メカニックへの譲渡は禁止します。\n\n例外：ニトロ缶の譲渡は可能とします。\n\nヘリ・飛行機の性能カスタムは禁止します。\n\n武装カスタム・防弾カスタムは禁止します。\n\n※ただし、外装パーツによる背面防弾化は許可します。\n\n防弾タイヤの取り付けは禁止します。\n\n2. カスタム済み車両の販売について\nカスタム車両の無料譲渡・個人販売は禁止します。\n\n例外：イベント景品やプレゼントでの譲渡は可（※悪用が発覚した場合は別途対応）\n\nメカニックがカスタム車両を販売する場合は以下を厳守すること。\n\n自身でディーラーから正規購入した車両のみ販売可能\n\n依頼を受けて代理購入・カスタム・販売する行為は禁止\n\nカスタム車両販売時の最低価格：\n\n本体車両価格 ＋ （外装以外のカスタム定価の80%）\nこれを下回る価格で販売してはいけません。\n\n3. メカニックの兼業・犯罪行為に関するルール\n3-1. ジョブ両立について\nメカニックとディーラーの両立は禁止します。\n\n3-2. 犯罪行為について\nメカニック雇用後に**犯罪行為（違法品の所持を含む）**を行った場合、闇メカニック扱いとします。\n\n闇メカニックがPD（警察）によって摘発された場合、そのメカニックは即時解雇・解体処分となります。\n\n犯罪者から白メカニックに復帰する場合：\n\n事前にPDへ連絡し、一定の監視期間を設けるなどの対応を推奨します。\n\n※貯金や強化車両を用いて不公平な状態で犯罪活動を行うことを防ぐため。" },
        { id: "7.2", description: "<b>【最低価格】</b>\n\n【最低修理料金】\n３０万円\n※１ヶ所で３０万ということではない\n\n【最低外装カスタム料金】\n１０万円\n※１ヶ所で３０万ということではない\n\n【最低性能カスタム料金】\n安すぎたらだめ最低でも１００万円以上はとるようにすること\n※１ヶ所でということではない" }
    ],
    "insyokuten-rules": [
    ...
    "criminal-rules": [
        ...
        { id: "9.5", description: "<b>【強盗 / ミッションにおける車両ルール】</b>\n\n\"全ての犯罪において\" オフロード車とバイクの使用を全面禁止。\n但し、パシフィックヘイストとユニオンヘイストにおいては、バイク可とする。（オフロードは不可）\n\n重強盗以上の犯罪で白い服装や車両をして行う事を禁止\n\n重強盗罪の以外で『ニトロ』の使用を禁止\n但し、犯罪者と警察でニトロ使用可の取り決めを行うことは良いとする。\n※パレト,軍事物資 は除く\n\n防弾や武器のついた車両の使用を禁止\n\n重強盗における逃走に使う車両は自家用車で良く、カスタムを行って良い\n\n準重強盗以下における逃走に使う車両は窃盗車を使う必要があるが、カスタムは行っても良い\n※購入したボートやヘリも使ってはならない。\n※犯罪関係については制限を設けない\n※パレト,軍事物資,オイルリグ,ボブキャット は除く\n\n何らかのミッションを行っていて、アジトやハウジング等に逃げ込む場合は、逃走フェーズが始まってから最低５分間はアジトやハウジング等に入る行為を禁止\n\nミッション実行時以外では上記のルールは適用されない。\n( オフロードカーやバイク、ニトロなどを使用して良い。 )" },
        { id: "9.6", description: "<b>【受注犯罪について】</b>\n\n・全犯罪\n受注後にSWATがいないくても、ミッションは続行してもよい\n\n・飛行場襲撃\n飛行機に向かってロケラン＆アタックを極力控えること\n飛行場のスタートするときは、参加者全員、ゲート入り口前からスタートするようにすること\n\n・客船強盗\n客船強盗をスタートするときは全員船尾からスタートすること、先に屋上などに配置するのは禁止\n\n・アーティファクト強盗\n参加者全員アーティファクト強盗を行う島内にある南北を結んでいる線路よりも東側からスタートをすること\n\n・オイルリグ強盗\n参加者全員オイルリグの建物に触れていない状態からスタートをすること" },
        { id: "9.7", description: "<b>【歪み＆補填について】</b>\n\n歪みで受け取れなった場合、その場に1ヵ所30秒待機すること。\nそして、その待機している時間を記録する動画を提出すると補填対象となる。" },
        { id: "9.8", description: "<b>【重強盗以上の犯罪について】</b>\n\nギャングじゃない人が受注する行為を禁止" },
        { id: "9.9", description: "<b>【走り方について】</b>\n\nflee4 のような戦闘で有利になるエモートを使用して犯罪を行う行為を禁止\n\n例（随時追加よてい）\n・bigfoot" }
    ],
    "gang-rules": [
        ...
        { id: "10.6", description: "<b>【ミッションへの参加人数について】</b>\n\n最高人数を、警察の出勤人数プラス２人まで参加可能とする" },
        { id: "10.7", description: "<b>【略奪について】</b>\n\n現地スタート禁止\n必ずアジトからスタートすること\n\nヘリは１ギャング１台までとする。\n絶対３人で行うこと 。\n服装は戦闘服で揃えて行うこと。\n装甲車の使用禁止\n\n１台のヘリに２人以上乗る行為を禁止\n範囲は目安であり、その中で戦わないといけないわけではない。\n中から外を撃ってもいいし、外から中を撃ってもよし。\n\nROBは緑の園内でのみ可能" }
    ],
    "related-rules": [
        { id: "11.1", description: "<b>【全般】</b>\n犯罪者や警察に対してリスペクトを欠かさないようにすること\n\n闇医者の最終目的は怪我で歩けない場合やダウンしている犯罪者の逃亡を成功させることである\n\n闇医者は救急隊との差を明確にするため、白市民に対しては暴利であるべきである\n\n闇医者は逃走補助の為、現場に介入する際”仮に補助の現場を抑えられていなくても\n逃走補助を目的として現場に介入している認識をもつべきである\n\nもしミッション中警察から警告を無しに打たれても、それを理由に文句を言ったりストーリーにして報復をする行為を禁止" },
        { id: "11.2", description: "<b>【基本ルール】</b>	\n\n警察へのアタックををしないように心がけること。\nもしアタックや殺害を行ってしまったら素直に謝ること。\n\nヘリの使用をスパロー＆シースパローのみとする\n\n助ける時のみバイクの使用を許可する\n\n犯罪現場に対して近づいた際に撃たれても自己責任となる\n\n個人医は一切の攻撃を行ってはならない\n\n個人医はギャングへの所属をしてはならない\n\n個人医として犯罪現場に向かうときは白い服を着用しなければならない\n\nクリニックは警察にばれないように努めなければならない\n\n警察から呼びかけられたら返事をするようにすること\n例 警察「離れてくださーい」闇医者「はーい」" },
    ...
    "tokubetu-rules": [
        ...
        { id: "12.2", description: "<b>【金庫強盗について】</b>\n\n人質を必要として、納品するまでアタックをなるべく避けるようにすること\n※歪みの原因になるため" }
    ]
};
